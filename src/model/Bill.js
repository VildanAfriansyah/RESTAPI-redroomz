...
const history   =   `SELECT bill.id_bill, booking.id_booking, profile.id_user, booking.name AS name_booking, booking.checkin, booking.checkout, bill.total_price, hotels.id_hotel, hotels.name AS name_hotel, hotels.price, booking.checkin, booking.checkout FROM profile 
