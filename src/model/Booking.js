...
const history   =   `SELECT booking.id_booking, profile.id_user, booking.name AS name_booking, hotels.id_hotel, hotels.name, rooms.id_room, rooms.name, booking.checkin, booking.checkout FROM profile 
